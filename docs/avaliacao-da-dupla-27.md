...
Integrantes: Bárbara Beatriz Sá da Silva e Bruno Gadêlha Mariz

Data de Preenchimento: 19/11/2025
...
Justificativa (descreva o que vocês fizeram e por que):

O site usou modularização. O header e o footer foram modularizados
...
Justificativa (descreva os recursos de acessibilidade implementados):

O site contém skip link e html semântico completo e correto.
...
O site é responsivo e funcionando perfeitamente.
...
O site tem uma ótima organização, estrutura de páginas profissional, código limpo.





O site tem uma ótima organização pastas organizada de forma profissional, com nomes padronizados e fáceis de entender. Os comentários estão posicionados de maneira adequada, explicando a lógica do código. O projeto está limpo, sem repetições desnecessárias, e pronto para ser mantido por outros desenvolvedores.
...
O site possui design muito limpo e bonito.
...
Site construído com código hierarquizado e organizado.
...
Justificativa (descreva como melhoraram a experiência do usuário):

Navegação bem rápida e imagens convertidas para carregamento mais rápido.
...
Justificativa (descreva como o design reflete o negócio escolhido): 

Projeto conecta bem com o estabelecimento e promove uma sofisticação à empresa.
...
Critério 1: Adicionar recursos mais tecnológicos.

Ação para melhorar: Javascript mais avançado.
...
Projeto excelente, meus parabéns!!
